...
export class AdminComponent implements OnInit{
    ...
    ngOnInit() {
        ...
        this.matchService.getMatches(this.route.snapshot.queryParams['page']).subscribe((data:any) => {
    ...
    // saveMatch(formData) {
    //     this.matchService.saveMatch(formData).subscribe(data => {
    //         this.matchService.getMatches(this.route.snapshot.queryParams['page'])
    //         .subscribe((data:any) => {
    //             this.matches = data.matches;
    //             this.count = data.count;
    //             this.maxPage = Math.ceil(this.count/10)})
